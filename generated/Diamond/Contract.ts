...
export class Contract extends ethereum.SmartContract {
  ...
  getTokenIDArray(): Array<BigInt> {
    let result = super.call(
      "getTokenIDArray",
      "getTokenIDArray():(uint256[])",
      []
    );
  ...
  try_getTokenIDArray(): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "getTokenIDArray",
      "getTokenIDArray():(uint256[])",
      []
  ...
  tokenIDArray(param0: BigInt): BigInt {
    let result = super.call("tokenIDArray", "tokenIDArray(uint256):(uint256)", [
  ...
  try_tokenIDArray(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "tokenIDArray",
      "tokenIDArray(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
